...
export const PreSingleSettings: React.FC<PreSingleSettingsProps> = ({
    ...
    return (
        <main className="md:w-1/2 w-full md:px-0 px-10">
            <div className=" bg-white rounded-xl shadow-xl md:p-8 p-5">
                <h1 className="font-bold md:text-3xl md:mb-10 mb-5 text-center text-nowrap">クイズをカスタマイズしよう！</h1>
                        ...
                        <div className="flex gap-2">
                            {difficulties.map((diff) => (
                                <button
                                    ...
                                    className={`flex-1 px-3 py-2 rounded-md md:text-sm font-medium transition-colors text-[10px]
                                            ${difficulty === diff
